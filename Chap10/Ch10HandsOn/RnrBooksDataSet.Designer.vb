...
Partial Public Class RnrBooksDataSet
    ...
    Partial Public Class BooksDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public Overloads Function AddBooksRow(ByVal ISBN As String, ByVal Title As String, ByVal Author As String, ByVal Publisher As String) As BooksRow
            Dim rowBooksRow As BooksRow = CType(Me.NewRow,BooksRow)
            Dim columnValuesArray() As Object = New Object() {ISBN, Title, Author, Publisher}
...
Namespace RnrBooksDataSetTableAdapters
    ...
    Partial Public Class BooksTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Books] ([ISBN], [Title], [Author], [Publisher]) VALUES (@ISBN,"& _ 
                " @Title, @Author, @Publisher);"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT ISBN, Title, Author, Publisher FROM Books"& _ 
                " WHERE (ISBN = @ISBN)"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Books] SET [ISBN] = @ISBN, [Title] = @Title, [Author] = @Author, [P"& _ 
                "ublisher] = @Publisher WHERE (([ISBN] = @Original_ISBN) AND ((@IsNull_Title = 1 "& _ 
                "AND [Title] IS NULL) OR ([Title] = @Original_Title)) AND ((@IsNull_Author = 1 AN"& _ 
                "D [Author] IS NULL) OR ([Author] = @Original_Author)) AND ((@IsNull_Publisher = "& _ 
                "1 AND [Publisher] IS NULL) OR ([Publisher] = @Original_Publisher)));"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT ISB"& _ 
                "N, Title, Author, Publisher FROM Books WHERE (ISBN = @ISBN)"
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = Ch10HandsOn.Settings.Default.RnrBooksConnectionString
        End Sub
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT ISBN, Title, Author, Publisher FROM dbo.Books"
        ...
        Public Overloads Overridable Function Delete(ByVal Original_ISBN As String, ByVal Original_Title As String, ByVal Original_Author As String, ByVal Original_Publisher As String) As Integer
        ...
        Public Overloads Overridable Function Insert(ByVal ISBN As String, ByVal Title As String, ByVal Author As String, ByVal Publisher As String) As Integer
        ...
        Public Overloads Overridable Function Update(ByVal ISBN As String, ByVal Title As String, ByVal Author As String, ByVal Publisher As String, ByVal Original_ISBN As String, ByVal Original_Title As String, ByVal Original_Author As String, ByVal Original_Publisher As String) As Integer
            If (ISBN Is Nothing) Then
                Throw New Global.System.ArgumentNullException("ISBN")
            Else
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Update, true)>  _
        Public Overloads Overridable Function Update(ByVal Title As String, ByVal Author As String, ByVal Publisher As String, ByVal Original_ISBN As String, ByVal Original_Title As String, ByVal Original_Author As String, ByVal Original_Publisher As String) As Integer
            Return Me.Update(Original_ISBN, Title, Author, Publisher, Original_ISBN, Original_Title, Original_Author, Original_Publisher)
        End Function
    End Class
End Namespace
